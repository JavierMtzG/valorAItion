...
def analyze_results(accuracy, conf_matrix, class_report):
    ...
    print("\nExtrayendo importancia global de términos...")
    ...
    plt.title("Importancia global de los términos")
    plt.tight_layout()
    plt.savefig("global_term_importance.png")
    print("\nGráfico de importancia global guardado como 'global_term_importance.png'")
